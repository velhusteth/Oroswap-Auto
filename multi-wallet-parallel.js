...
// Delay function cho từng ví riêng biệt
...
async function runMultiWalletBotParallel() {
    ...
    console.log(`\n🎯 Bắt đầu chạy bot cho 1 ví đa luồng...`);
    console.log(`⚠️  Cảnh báo: Chạy đa luồng có thể gây tải cao cho RPC node!`);
    ...
    try {
        ...
        console.error(`\n❌ Có lỗi xảy ra trong quá trình chạy:`, error.message);
    }
}
